...
SECRET_KEY = 'django-insecure--y79a9ew@b$ypa5&v6rwemw^5#@s09jrh9x927a0t@ra6)qm3e'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')], #indicamos la ruta de la carpeta templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_HOST_PASSWORD = 'knha izjh biek khqe'
DEFAULT_FROM_EMAIL = 'daniel.cabrera.araya@gmail.com'  # Dirección desde la que se enviarán los correos
