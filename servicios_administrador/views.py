...
def disponibilidad_view(request):
    if request.method == 'POST':
        ...
        return redirect('mi_web/Confirmacion.html') #Redirect es una función que redirige al usuario a otra URL después de que se haya procesado el formulario. En este caso, redirige a la plantilla 'Confirmacion.html' después de guardar la disponibilidad en la base de datos.
...
def confirmacion_adm_view(request):
